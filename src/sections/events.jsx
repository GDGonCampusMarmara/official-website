...
export default function Events() {
  ...
  const scrollToCalendar = () => document.getElementById('calendar-content')?.scrollIntoView({ behavior: 'smooth' });
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden text-center">
        ...
        <div className="relative z-[2] p-8">
          <div className="inline-flex items-center gap-2 rounded-full py-[6px] px-[18px] text-[12px] tracking-[.14em] uppercase text-[#f8f6f1]/45 border border-white/10 backdrop-blur-[12px] mb-10">
            <span className="w-[6px] h-[6px] rounded-full inline-block bg-[#f9ab00] [animation:ev-pulse_2s_infinite]" />
            Lorem ipsum dolor sit amet consectetur
          </div>

          <h1 className="font-['Google_Sans',sans-serif] text-[clamp(80px,16vw,220px)] leading-[.88] tracking-[-0.01em] text-[#f8f6f1]">
            Events<br />
            <em className="font-['Google_Sans',serif] italic text-[#f9ab00] text-[.75em]">Calendar</em>
          </h1>
        ...
        <button
          className="absolute bottom-10 left-1/2 -translate-x-1/2 z-[2] flex flex-col items-center gap-2 text-[11px] tracking-[.12em] uppercase text-[#f8f6f1]/45 border-0 bg-transparent cursor-pointer [animation:ev-fadein_2s_1s_both]"
          onClick={scrollToCalendar}
        >
          <div className="w-px h-[50px] bg-[linear-gradient(to_bottom,rgba(255,255,255,0.3),transparent)] [animation:ev-scroll-down_2s_1s_infinite]" />
          Keşfet
        </button>
      </div>
